...
```{r}
trainingset <- read.csv("C:/Users/anil/Documents/trainingdata.csv", na.strings=c("NA","#DIV/0!", ""))
```
# Loading the testing data set 
```{r}
testingset <- read.csv('C:/Users/anil/Documents/testingdata.csv', na.strings=c("NA","#DIV/0!", ""))
```
